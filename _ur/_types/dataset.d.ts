...
export type UR_DatasetObj = {
  ...
  // runsessions
  // templates
  // Also see util-data-ops.ts for the equivalent foldernames
};
 ...
 *  requested by name */
export type UR_Manifest = {
  _schema: UR_SchemaID;
  _dataURI: UR_DatasetURI;
  _created_by: string; // autogenerated, or author name
  _created_on: string; // date of creation
  _info: string; // from info file
  ItemLists?: string[]; // list of databin in dataset
