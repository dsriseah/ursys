...
var require_declare_async = __commonJS({
  "_ur/common/declare-async.js"(exports, module) {
    var APP_LIFECYCLE = {
      SETUP: [
        "INITIALIZE",
...
var require_declare_errors = __commonJS({
  "_ur/common/declare-errors.js"(exports, module) {
    var EXIT_CODES = {
      ERR_UR: 444
...
var require_util_error_mgr = __commonJS({
  "_ur/common/util-error-mgr.js"(exports, module) {
...
function DecodeAddonArgs(argv) {
  ...
  const addonScript = PATH2.basename(a_enp, PATH2.extname(a_enp));
  return [
    addonScript,
...
function ValidateAddon(addon) {
  const ADDONS = PATH2.join(DetectedRootDir(), "_ur_addons");
  if (!DirExists(ADDONS)) {
  ...
  const addon_dir = PATH2.join(ADDONS, addonName);
  ...
  if (!entryName) {
    if (entryFiles.length > 0) {
      ...
      entryName = PATH2.basename(entryFile, PATH2.extname(entryFile));
      return {
        addonName,
        entryName,
        entryFile,
...
export {
  ur_addon_mgr_exports as ADDONMGR,
  appserver_exports as APPSERV,
  CLASS,
  env_node_exports as ENV,
  files_exports as FILE,
  Initialize,
  makeTerminalOut4 as PR,
  processes_exports as PROC,
  export_TEXT as TEXT
};
//# sourceMappingURL=server-esm.mjs.map
